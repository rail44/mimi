...
var createElement = _interopDefault(infernoCreateElement);
var Component = _interopDefault(infernoComponent);

var Inferno__default = _interopDefault(inferno);
var pathToRegexp = _interopDefault(pathToRegexp_1);
...
var pathToRegexpEs6 = createCommonjsModule$$1((function (module) {
/**
...
var infernoRouter = createCommonjsModule(function (module) {
module.exports = dist$2.default;
module.exports.default = module.exports;
});

var infernoRouter_1 = infernoRouter.Router;
var infernoRouter_2 = infernoRouter.Route;
...
var infernoRedux = createCommonjsModule(function (module) {
module.exports = dist$4.default;
module.exports.default = module.exports;
});

var infernoRedux_1 = infernoRedux.Provider;
...
var infernoHyperscript = createCommonjsModule(function (module) {
module.exports = dist$5.default;
module.exports.default = module.exports;
});
...
class BasicComponent1 extends infernoComponent {
  render() {
    ...
    return (
      infernoHyperscript('.basic', [
        infernoHyperscript('a#dispatch', {onClick}, [
          infernoHyperscript('span', ['Hello', state.name || 'Tom']),
        ]),
      ])
    );
  }
...
class BasicComponent2 extends infernoComponent {
  render() {
    const store = this.context.store;
    const state = store.getState();

    return (
      infernoHyperscript('.basic2', [
...
inferno.render(
  infernoHyperscript(infernoRedux_1, {store},
    infernoHyperscript(infernoRouter_1, {url: '/', history: browserHistory}, [
      infernoHyperscript(infernoRouter_2, {path: '/next', component: BasicComponent2 }),
      infernoHyperscript(infernoRouter_2, {path: '/', component: BasicComponent1 }),
    ]),
  ),
  container
);
